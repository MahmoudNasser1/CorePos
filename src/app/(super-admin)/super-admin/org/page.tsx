...
export default async function PlatformOrgUnitsPage() {
  return (
    <div className="space-y-6" dir="rtl">
      <PageHeader title="الإدارات (Org Units)" subtitle="إدارة الإدارات داخل الشركات وربط المستخدمين بها (مرحلة 4)." />
      <OrgUnitsClient />
    </div>
  )
}
